...
namespace CSharpEgitimKampi301.EFProject
{
    public partial class FrmStatistics : Form
    {
        ...
        private void FrmStatistics_Load(object sender, EventArgs e)
        {
            ...
            int lastCountryId = db.Location.Max(x => x.LocationnId);
            lblLastCountryName.Text = db.Location.Where(x => x.LocationnId == lastCountryId).Select(y => y.Country).FirstOrDefault();
